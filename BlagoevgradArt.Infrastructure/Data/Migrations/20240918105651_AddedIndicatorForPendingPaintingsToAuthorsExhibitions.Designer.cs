...
namespace BlagoevgradArt.Infrastructure.Migrations
{
    ...
    [Migration("20240918105651_AddedIndicatorForPendingPaintingsToAuthorsExhibitions")]
    partial class AddedIndicatorForPendingPaintingsToAuthorsExhibitions
    {
            ...
            modelBuilder.Entity("BlagoevgradArt.Infrastructure.Data.Models.AuthorExhibition", b =>
                {
                    ...
                    b.Property<bool>("HasPendingPaintings")
                        .HasColumnType("bit")
                        .HasComment("An indicator if the Author has pending Paintings to be approved. | Индикатор дали Авторът има чакащи картини за одобрение.");

                    b.Property<bool>("IsAccepted")
                        .HasColumnType("bit")
                        .HasComment("An indicator if the Author is accepted into the Exhibition. | Индикатор дали Авторът е приет в Изложбата.");
            ...
            modelBuilder.Entity("BlagoevgradArt.Infrastructure.Data.Models.Exhibition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OpeningDate = new DateTime(2024, 10, 13, 15, 0, 0, 0, DateTimeKind.Local)
                        });
                });
            ...
            modelBuilder.Entity("BlagoevgradArt.Infrastructure.Data.Models.Painting", b =>
                {
                    ...
                    b.Property<bool>("IsAccepted")
                        .HasColumnType("bit")
                        .HasComment("Indicator if the Painting is accepted in an Exhibition. | Индикатор дали картината е приета в изложба.");
            ...
            modelBuilder.Entity("BlagoevgradArt.Infrastructure.Data.Models.AuthorHelperUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0b626380-e12c-4f36-aa52-57585a2d7319",
                            Email = "vladimaistora@mail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "vladimaistora@mail.com",
                            NormalizedUserName = "vladimaistora@mail.com",
                            PasswordHash = "AQAAAAEAACcQAAAAEApwHL4I0EV1RV6st5XCxfyMJxyahzVkZF+5TM0kJji1jAmvO63SxVXioGIsUGS/3Q==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "082a420a-669c-45e8-b4b8-eb6359156f51",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4ccdf86b-cf2c-4782-b7cf-8e02eec4a5c1",
                            Email = "tsankolavrenov@mail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "tsankolavrenov@mail.com",
                            NormalizedUserName = "tsankolavrenov@mail.com",
                            PasswordHash = "AQAAAAEAACcQAAAAEFid9hCz2XsxWxJ8n6vi8BogQtP2XcH1nIV3DwGeGwvaCCNe71iaU/iuUEO5gNpt5w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "37d34482-d92e-4478-8272-5cd65796efbb",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("BlagoevgradArt.Infrastructure.Data.Models.GalleryHelperUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "86e6d731-e0cf-47d3-84bb-96cb0729a0bf",
                            Email = "gallery@mail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "gallery@mail.com",
                            NormalizedUserName = "gallery@mail.com",
                            PasswordHash = "AQAAAAEAACcQAAAAEBcUvDA13dSwupDzEnpczCmGf/0kJfedlB/Pn5iBSDQaM128mwbMfCxl0BV4L6Cptw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "8009dab9-41e9-4d6b-a223-4fcd2ace0071",
                            TwoFactorEnabled = false,
